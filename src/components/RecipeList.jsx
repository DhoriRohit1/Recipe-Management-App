...
const RecipeList = ({ recipes, setSelectedRecipe, deleteRecipe }) => {
    return (
        <>
            <h2 className='text-primary'>Recipes</h2>

        <div className="row mt-4">
            {recipes.length === 0 ? (
                <div className="col-12 mt-3">
                    <p className='text-danger'>No recipes available.</p>
                </div>
            ) : (
                recipes.map(recipe => (
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between">
                                    <button className="btn btn-secondary btn-sm" onClick={() => setSelectedRecipe(recipe)}>Edit</button>
